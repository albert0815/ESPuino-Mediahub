...
- **Aufräumen automatisch:** Folgen, die keine Karte mehr referenziert (aus dem „neueste N“-Fenster gerutscht, Auswahl geändert, Karte gelöscht), werden nach jedem Sync und bei jedem Karten-/Geräte-Löschen entfernt. Anders als Bibliotheksdateien (§5.4) gehören sie dem Hub, also darf und muss er sie löschen. Die Cache-Größe steht auf der Medien-Seite.
